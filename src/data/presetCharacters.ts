...
const presetDefs: PresetCharacterDef[] = [
  {
    ...
    skills: [
      ...
      { name: '居合·烈', description: '居合术的极致，一瞬间的拔刀重斩', damageMultiplier: 2.2, type: 'attack' },
      { name: '武士道精神', description: '凝聚战意，提升攻击力', damageMultiplier: 0, type: 'buff', buffPercent: 65, buffTurns: 3 },
      { name: '残影步', description: '留下残影迷惑对手，降低其攻击', damageMultiplier: 0, type: 'debuff', buffPercent: 55, buffTurns: 2 },
      {
        name: '天照·一闪',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '超新星', description: '引爆恒星碎屑', damageMultiplier: 2.7, type: 'attack' },
      { name: '时空回溯', description: '扭曲时间恢复生命', damageMultiplier: 0, type: 'heal', healPercent: 38 },
      { name: '黑洞引力', description: '召唤微型黑洞削弱对手', damageMultiplier: 0, type: 'debuff', buffPercent: 65, buffTurns: 3 },
      {
        name: '宇宙大爆炸',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '等离子炮', description: '发射等离子能量束', damageMultiplier: 2.0, type: 'attack' },
      { name: '纳米修复', description: '纳米机器人修复装甲', damageMultiplier: 0, type: 'heal', healPercent: 28 },
      { name: 'EMP脉冲', description: '释放电磁脉冲瘫痪对手', damageMultiplier: 0, type: 'debuff', buffPercent: 65, buffTurns: 2 },
      {
        name: '终极毁灭程序',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '致命背刺', description: '绕后背刺要害', damageMultiplier: 2.9, type: 'attack' },
      { name: '隐身术', description: '融入暗影提升攻击', damageMultiplier: 0, type: 'buff', buffPercent: 90, buffTurns: 2 },
      { name: '毒雾', description: '释放毒雾削弱对手', damageMultiplier: 0, type: 'debuff', buffPercent: 50, buffTurns: 3 },
      {
        name: '千刃杀',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '烈焰风暴', description: '召唤火焰旋风', damageMultiplier: 2.5, type: 'attack' },
      { name: '凤凰之翼', description: '凤凰之力加持', damageMultiplier: 0, type: 'buff', buffPercent: 75, buffTurns: 3 },
      { name: '灼烧大地', description: '点燃脚下大地', damageMultiplier: 0, type: 'debuff', buffPercent: 60, buffTurns: 2 },
      {
        name: '炼狱焚天',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '寒冰裂破', description: '冰刺从地底迸发', damageMultiplier: 2.2, type: 'attack' },
      { name: '冰甲护体', description: '凝结冰甲提升防御', damageMultiplier: 0, type: 'buff', buffPercent: 80, buffTurns: 3 },
      { name: '冰冻领域', description: '降低温度冻结对手', damageMultiplier: 0, type: 'debuff', buffPercent: 62, buffTurns: 2 },
      {
        name: '绝对零度',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '昊天锤', description: '召唤昊天锤重击，力破千军', damageMultiplier: 2.4, type: 'attack' },
      { name: '玄天功', description: '运转玄天功，战意暴涨', damageMultiplier: 0, type: 'buff', buffPercent: 70, buffTurns: 3 },
      { name: '紫极魔瞳', description: '紫极魔瞳洞悉破绽，削弱对手防御', damageMultiplier: 0, type: 'debuff', buffPercent: 58, buffTurns: 2 },
      {
        name: '海神·无定风波',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '七十二变', description: '化身万千，虚实难辨的连击', damageMultiplier: 2.4, type: 'attack' },
      { name: '火眼金睛', description: '识破虚妄，攻击力大幅提升', damageMultiplier: 0, type: 'buff', buffPercent: 80, buffTurns: 2 },
      { name: '筋斗云', description: '腾云驾雾，让对手难以命中', damageMultiplier: 0, type: 'debuff', buffPercent: 55, buffTurns: 2 },
      {
        name: '法天象地',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '奥特飞踢', description: '从高空俯冲的爆裂飞踢', damageMultiplier: 2.3, type: 'attack' },
      { name: '光之护盾', description: '展开光墙提升防御', damageMultiplier: 0, type: 'buff', buffPercent: 75, buffTurns: 2 },
      { name: '奥特念力', description: '以念力压制对手，削弱其攻击', damageMultiplier: 0, type: 'debuff', buffPercent: 52, buffTurns: 2 },
      {
        name: '闪耀·斯派修姆光线',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '集束炸弹', description: '发射微型导弹火力覆盖', damageMultiplier: 2.4, type: 'attack' },
      { name: '能量护盾', description: '展开纳米能量场防御', damageMultiplier: 0, type: 'buff', buffPercent: 70, buffTurns: 3 },
      { name: '电磁干扰', description: '释放 EMP 扰乱对手系统', damageMultiplier: 0, type: 'debuff', buffPercent: 60, buffTurns: 2 },
      {
        name: '反浩克装甲·最终协议',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '弧线任意球', description: '划出完美弧线直挂死角', damageMultiplier: 2.6, type: 'attack' },
      { name: '上帝视野', description: '洞察全场，传球与进攻如有神助', damageMultiplier: 0, type: 'buff', buffPercent: 75, buffTurns: 3 },
      { name: '贴身盯防', description: '压迫式防守让对手难以施展', damageMultiplier: 0, type: 'debuff', buffPercent: 45, buffTurns: 3 },
      {
        name: '世纪进球·上帝之手',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '暴力头球', description: '弹跳惊人，头球轰门', damageMultiplier: 2.7, type: 'attack' },
      { name: '钢铁意志', description: '永不言弃的斗志激发潜能', damageMultiplier: 0, type: 'buff', buffPercent: 80, buffTurns: 2 },
      { name: '踩单车迷惑', description: '花式动作晃晕对手防线', damageMultiplier: 0, type: 'debuff', buffPercent: 48, buffTurns: 2 },
      {
        name: 'SIUUU·惊天倒钩',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '雷切', description: '凝聚雷电于掌心突刺', damageMultiplier: 2.6, type: 'attack' },
      { name: '写轮眼复制', description: '看穿并复制对手动作，提升攻击', damageMultiplier: 0, type: 'buff', buffPercent: 75, buffTurns: 3 },
      { name: '土遁·土流壁', description: '筑起土墙提升防御', damageMultiplier: 0, type: 'buff', buffPercent: 65, buffTurns: 2 },
      {
        name: '神威·雷切双雷震',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: '暗影球', description: '投掷浓缩暗影能量球', damageMultiplier: 2.8, type: 'attack' },
      { name: '自我再生', description: '以超能力修复自身伤势', damageMultiplier: 0, type: 'heal', healPercent: 45 },
      { name: '冥想', description: '集中精神，攻击力大幅提升', damageMultiplier: 0, type: 'buff', buffPercent: 90, buffTurns: 3 },
      {
        name: '精神破坏·无限精神力',
